...
public class CopperOreBlockBlock extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:copper_ore_block")
	public static final Block block = null;
	public CopperOreBlockBlock(NaidruMoreItemsModModElements instance) {
		super(instance, 31);
	}
