...
public class CloudBlockBlock extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:cloud_block")
	public static final Block block = null;
	public CloudBlockBlock(NaidruMoreItemsModModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.AIR).sound(SoundType.SNOW).hardnessAndResistance(0f, 0f).lightValue(0).notSolid());
