...
public class SkyOreBlockBlock extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:sky_ore_block")
	public static final Block block = null;
	public SkyOreBlockBlock(NaidruMoreItemsModModElements instance) {
		super(instance, 110);
	}
