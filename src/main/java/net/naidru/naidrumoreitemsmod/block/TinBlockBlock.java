...
public class TinBlockBlock extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:tin_block")
	public static final Block block = null;
	public TinBlockBlock(NaidruMoreItemsModModElements instance) {
		super(instance, 27);
	}
