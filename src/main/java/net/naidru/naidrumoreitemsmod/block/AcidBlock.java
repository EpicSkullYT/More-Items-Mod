...
public class AcidBlock extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("naidru_more_items_mod:acid_bucket")
	public static final Item bucket = null;
	private FlowingFluid flowing = null;
	private FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public AcidBlock(NaidruMoreItemsModModElements instance) {
		super(instance, 150);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						.builder(new ResourceLocation("naidru_more_items_mod:blocks/acid"), new ResourceLocation("naidru_more_items_mod:blocks/acid"))
		...
		elements.items.add(
				() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(MoreItemsModMiscTabItemGroup.tab))
