...
public class SilverOreBlock extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(NaidruMoreItemsModModElements instance) {
		super(instance, 51);
	}
