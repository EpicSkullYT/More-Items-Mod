...
public class TinOreBlock extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:tin_ore")
	public static final Block block = null;
	public TinOreBlock(NaidruMoreItemsModModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 15f).lightValue(0).harvestLevel(1)
