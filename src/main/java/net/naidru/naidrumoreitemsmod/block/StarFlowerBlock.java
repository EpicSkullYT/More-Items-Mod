...
import net.naidru.naidrumoreitemsmod.item.StarPollenItem;
...
public class StarFlowerBlock extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:star_flower")
	public static final Block block = null;
	public StarFlowerBlock(NaidruMoreItemsModModElements instance) {
		super(instance, 145);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(StarPollenItem.block, (int) (1)));
		}
