...
package net.naidru.naidrumoreitemsmod.world.structure;
...
public class UndergroundTempleStructure extends NaidruMoreItemsModModElements.ModElement {
	public UndergroundTempleStructure(NaidruMoreItemsModModElements instance) {
		super(instance, 90);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 5000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("naidru_more_items_mod", "underground_temple"));
						if (template == null)
							return false;
