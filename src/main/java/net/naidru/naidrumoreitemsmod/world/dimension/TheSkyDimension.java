...
package net.naidru.naidrumoreitemsmod.world.dimension;

import org.jline.terminal.Size;

import net.naidru.naidrumoreitemsmod.item.TheSkyItem;
import net.naidru.naidrumoreitemsmod.block.CloudBlockBlock;
...
public class TheSkyDimension extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:the_sky")
	public static final ModDimension dimension = null;
	@ObjectHolder("naidru_more_items_mod:the_sky_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public TheSkyDimension(NaidruMoreItemsModModElements instance) {
		super(instance, 106);
	...
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("naidru_more_items_mod:the_sky")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("naidru_more_items_mod:the_sky"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("naidru_more_items_mod:the_sky"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("naidru_more_items_mod:sky_biome")),};
	}
