...
public class CopperPickaxeItem extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:copper_pickaxe")
	public static final Item block = null;
	public CopperPickaxeItem(NaidruMoreItemsModModElements instance) {
		super(instance, 36);
	}
