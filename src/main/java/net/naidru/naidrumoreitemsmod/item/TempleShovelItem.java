...
public class TempleShovelItem extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:temple_shovel")
	public static final Item block = null;
	public TempleShovelItem(NaidruMoreItemsModModElements instance) {
		super(instance, 82);
	}
