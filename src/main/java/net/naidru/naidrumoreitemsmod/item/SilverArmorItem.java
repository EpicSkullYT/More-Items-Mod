...
public class SilverArmorItem extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:silver_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("naidru_more_items_mod:silver_armorbody")
	public static final Item body = null;
	@ObjectHolder("naidru_more_items_mod:silver_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("naidru_more_items_mod:silver_armorboots")
	public static final Item boots = null;
	public SilverArmorItem(NaidruMoreItemsModModElements instance) {
		super(instance, 67);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(MoreItemsModArmorTabItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "naidru_more_items_mod:textures/models/armor/silver_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
