...
public class TempleSwordItem extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:temple_sword")
	public static final Item block = null;
	public TempleSwordItem(NaidruMoreItemsModModElements instance) {
		super(instance, 81);
	}
