...
public class IceArmorItem extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:ice_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("naidru_more_items_mod:ice_armorbody")
	public static final Item body = null;
	@ObjectHolder("naidru_more_items_mod:ice_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("naidru_more_items_mod:ice_armorboots")
	public static final Item boots = null;
	public IceArmorItem(NaidruMoreItemsModModElements instance) {
		super(instance, 91);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(MoreItemsModArmorTabItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "naidru_more_items_mod:textures/models/armor/ice_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
				}.setRegistryName("ice_armorhelmet"));
		elements.items
		...
		elements.items
				...
				}.setRegistryName("ice_armorboots"));
	}
}
