...
public class IcePickaxeItem extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:ice_pickaxe")
	public static final Item block = null;
	public IcePickaxeItem(NaidruMoreItemsModModElements instance) {
		super(instance, 96);
	}
