...
public class IceAxeItem extends NaidruMoreItemsModModElements.ModElement {
	@ObjectHolder("naidru_more_items_mod:ice_axe")
	public static final Item block = null;
	public IceAxeItem(NaidruMoreItemsModModElements instance) {
		super(instance, 97);
	}
